...
@Autonomous(name="ADS_Close_Blue", group="Linear OpMode")
public class ADS_Close_Blue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Pose2d Drive_from_start = new Pose2d(-67, -39, Math.toRadians(90));
        ...
        Actions.runBlocking(
                drive.actionBuilder(LP_EP)
                        .strafeToLinearHeading(new Vector2d(-23.50,-50),Math.toRadians(10))
                        .build()
